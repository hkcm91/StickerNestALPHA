...
description: >
  Quick-reference terminology card for StickerNest V5. Use when checking correct
  terminology ("is it Canvas or board?"), when writing documentation or content
  about StickerNest, when verifying entity types, DataSource types, store names,
  SDK methods, or layer boundaries.
---
