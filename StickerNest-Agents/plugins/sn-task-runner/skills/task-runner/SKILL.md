...
name: task-runner
description: >
  This skill is the primary code-writing workflow for StickerNest V5. Use when
  the user assigns a coding task, says "build this feature", "fix this bug",
  "implement the widget", or any code-writing request targeting the StickerNest
  codebase. Enforces layer-aware development, test-driven workflow, and
