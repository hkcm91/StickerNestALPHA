...
const styles: Record<string, React.CSSProperties> = {
  container: { display: 'flex', flexDirection: 'column', width: '320px', borderLeft: '1px solid var(--sn-border, #ddd)', background: 'var(--sn-surface, #fff)', height: '100%', overflow: 'auto' },
  ...
  modeBtn: { display: 'flex', flexDirection: 'column', alignItems: 'flex-start', padding: '10px 12px', background: 'var(--sn-bg, #f8f9fa)', border: '1px solid var(--sn-border, #ddd)', borderRadius: 'var(--sn-radius, 6px)', cursor: 'pointer', textAlign: 'left' as const, width: '100%' },
  modeBtnActive: { borderColor: 'var(--sn-accent, #2563eb)', background: 'rgba(37, 99, 235, 0.05)' },
  modeBtnDisabled: { opacity: 0.5, cursor: 'not-allowed' },
  modeBtnLabel: { fontWeight: 600, fontSize: '13px', color: 'var(--sn-text, #111)' },
  modeBtnDesc: { fontSize: '11px', color: 'var(--sn-text-muted, #666)', marginTop: '2px' },
  ...
  error: { margin: '0 12px', padding: '10px', background: '#fef2f2', border: '1px solid #fecaca', borderRadius: 'var(--sn-radius, 6px)', fontSize: '13px', color: '#991b1b' },
