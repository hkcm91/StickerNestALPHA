...
const styles: Record<string, React.CSSProperties> = {
  ...
  modal: { background: 'var(--sn-surface-glass, rgba(20,17,24,0.82))', backdropFilter: 'blur(40px) saturate(1.3)', WebkitBackdropFilter: 'blur(40px) saturate(1.3)', borderRadius: '12px', width: '440px', maxWidth: '90vw', display: 'flex', flexDirection: 'column', border: '1px solid rgba(78,123,142,0.12)' },
  ...
  label: { display: 'flex', flexDirection: 'column', gap: '4px', fontSize: '13px', fontWeight: 600, color: 'var(--sn-text, #E8E6ED)' },
  input: { padding: '8px 10px', border: '1px solid var(--sn-border, rgba(255,255,255,0.06))', borderRadius: 'var(--sn-radius, 6px)', fontSize: '14px', background: 'var(--sn-surface-glass, rgba(20,17,24,0.5))', color: 'var(--sn-text, #E8E6ED)', fontWeight: 400, outline: 'none' },
  select: { padding: '8px 10px', border: '1px solid var(--sn-border, rgba(255,255,255,0.06))', borderRadius: 'var(--sn-radius, 6px)', fontSize: '14px', background: 'var(--sn-surface-glass, rgba(20,17,24,0.5))', color: 'var(--sn-text, #E8E6ED)', fontWeight: 400 },
  checkboxLabel: { display: 'flex', alignItems: 'center', gap: '8px', fontSize: '13px', color: 'var(--sn-text, #E8E6ED)' },
  optionsSection: { display: 'flex', flexDirection: 'column', gap: '6px' },
  optionsList: { display: 'flex', flexWrap: 'wrap', gap: '4px' },
  optionItem: { display: 'inline-flex', alignItems: 'center', gap: '4px', padding: '3px 8px', background: 'var(--sn-surface-raised, #1A1A1F)', borderRadius: '4px', fontSize: '12px', color: 'var(--sn-text, #E8E6ED)' },
  optionRemoveBtn: { background: 'none', border: 'none', cursor: 'pointer', fontSize: '10px', color: 'var(--sn-text-muted, #7A7784)', padding: '0 2px' },
  optionInputRow: { display: 'flex', gap: '6px' },
  addOptionBtn: { padding: '8px 12px', background: 'var(--sn-surface-glass, rgba(20,17,24,0.75))', border: '1px solid var(--sn-border, rgba(255,255,255,0.06))', borderRadius: 'var(--sn-radius, 6px)', cursor: 'pointer', fontSize: '13px', color: 'var(--sn-text, #E8E6ED)' },
  footer: { display: 'flex', gap: '8px', padding: '14px 20px', borderTop: '1px solid var(--sn-border, rgba(255,255,255,0.06))' },
  cancelBtn: { padding: '8px 16px', background: 'var(--sn-surface-glass, rgba(20,17,24,0.75))', border: '1px solid var(--sn-border, rgba(255,255,255,0.06))', borderRadius: 'var(--sn-radius, 6px)', cursor: 'pointer', fontSize: '13px', color: 'var(--sn-text-muted, #7A7784)' },
  saveBtn: { padding: '8px 16px', background: 'var(--sn-accent, #3E7D94)', color: '#fff', border: 'none', borderRadius: 'var(--sn-radius, 6px)', cursor: 'pointer', fontWeight: 600, fontSize: '13px', boxShadow: '0 0 8px rgba(62,125,148,0.2)' },
  deleteBtn: { padding: '8px 16px', background: 'rgba(200,88,88,0.1)', color: '#C85858', border: '1px solid rgba(200,88,88,0.2)', borderRadius: 'var(--sn-radius, 6px)', cursor: 'pointer', fontSize: '13px' },
};
