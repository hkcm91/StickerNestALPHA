    ...
    >
      ...
      <div
        style={{
          ...
          background: `linear-gradient(180deg,
            ...
            color-mix(in srgb, var(--sn-storm, #4E7B8E) 3%, transparent) 100%)`,
          filter: "blur(110px)",
      ...
      <div
        style={{
          ...
          height: "135%",
          background: `linear-gradient(180deg,
            color-mix(in srgb, var(--sn-storm, #4E7B8E) 4%, transparent) 0%,
            color-mix(in srgb, var(--sn-opal, #B0D0D8) 5%, transparent) 50%,
            color-mix(in srgb, var(--sn-storm, #4E7B8E) 2%, transparent) 100%)`,
          filter: "blur(95px)",
