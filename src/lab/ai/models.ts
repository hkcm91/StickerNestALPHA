/**
 * AI Model Registry — Available models for widget code generation.
 *
 * @module lab/ai
 * @layer L2
 */
...
export interface AIModel {
  ...
  /** Replicate model path (e.g. 'moonshotai/kimi-k2') — only for provider='replicate' */
...
/**
 * All available AI models for widget generation.
 * Add new models here — the PromptBar dropdown reads from this list.
 */
